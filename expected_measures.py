...
# Stampa i valori di M per ogni cella
for key in sorted(M_values.keys()):
    print(f'Cell {key}: M0={M_values[key][0]:.1f}, M1={M_values[key][1]:.1f}, M2={M_values[key][2]:.1f}, M3={M_values[key][3]:.1f}')